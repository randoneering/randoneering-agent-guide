...
```bash
cd /Users/joliang/sva_copilot/cortex/snowpilot/semantic_view_autopilot/snova/skills && \
...
```bash
uv run python scripts/relationship_creation.py \
  --semantic-model creation/ecommerce_test_view_semantic_model.yaml \
  --left-table ORDERS \
...
uv run python semantic_view_set.py \
  --input-file ../../.claude/skills/semantic-view-optimization/creation/<semantic_view_name>_semantic_model.yaml \
  --output-file ../../.claude/skills/semantic-view-optimization/creation/<semantic_view_name>_semantic_model.yaml \
  --operations-json '[
...
```python
reflect_semantic_model(semantic_model_file="creation/<semantic_view_name>_semantic_model.yaml")
```
