...
parent_skill: semantic-view-optimization-debug
---
...
snowflake_multi_cortex_analyst(query="{question_1}", semantic_model_file="semantic_view_optimization_TIMESTAMP/current_semantic_model.yaml")
snowflake_multi_cortex_analyst(query="{question_2}", semantic_model_file="semantic_view_optimization_TIMESTAMP/current_semantic_model.yaml")
snowflake_multi_cortex_analyst(query="{question_3}", semantic_model_file="semantic_view_optimization_TIMESTAMP/current_semantic_model.yaml")
```
...
snowflake_multi_cortex_analyst(
    query="{user question}",
    semantic_model_file="semantic_view_optimization_TIMESTAMP/current_semantic_model.yaml"
)
```
